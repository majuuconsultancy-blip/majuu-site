...
export function SiteHeader({ content, launchContent, onDownloadUnavailable }) {
  ...
  return (
    <header
      ref={headerRef}
      className="sticky top-0 z-50 border-b border-white/60 bg-[rgba(250,249,244,0.68)] shadow-[0_8px_24px_rgba(15,23,42,0.035)] backdrop-blur-2xl"
    >
        ...
        <div className="mt-1.5 flex flex-col items-center gap-2 pb-1">
          ...
          <div className="flex w-full max-w-[20rem] items-center gap-2">
            ...
            <a
              ...
              className="inline-flex w-1/2 items-center justify-center rounded-full border border-emerald-700/30 bg-white px-3 py-1.5 text-center text-[0.74rem] font-semibold uppercase tracking-[0.06em] text-emerald-800 transition hover:-translate-y-0.5 hover:bg-emerald-50"
            >
              Become a Partner
            </a>
          </div>
      ...
      <aside
        className={`fixed left-0 z-[45] w-[280px] max-w-[86vw] overflow-y-auto border-r border-slate-200 bg-white p-4 shadow-xl transition-transform duration-300 ${
